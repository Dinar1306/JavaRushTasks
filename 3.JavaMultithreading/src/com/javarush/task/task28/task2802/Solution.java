        ...
        /*         @Override
                public Thread newThread(Runnable runnable) {
                   ...
                   String groupName = Thread.currentThread().getName();
                    AtomicInteger fabricNumber = new AtomicInteger(0);
                    AtomicInteger treadNumber = new AtomicInteger(0);
                    Thread test = new Thread();
                    test.setDaemon(false);
                    test.setPriority(0);
                    test.setName(groupName+"-"+fabricNumber.toString()+"-"+treadNumber.toString());
                    return test;
        */
