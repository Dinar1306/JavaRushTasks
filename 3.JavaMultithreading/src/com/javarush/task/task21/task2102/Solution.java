...
4. Метод isModifierSet должен возвращать корректное значение в соответствии с условием задачи(true, если заданный
...
public class Solution {
    ...
    public static boolean isModifierSet(int allModifiers, int specificModifier) {
        System.out.println("allModifiers " + Integer.toBinaryString(allModifiers) + ". specificModifier " + Integer.toBinaryString(specificModifier));
        int mod = allModifiers & specificModifier;
        return mod == specificModifier ? true : false; //Реализовать логику метода isModifierSet, который проверяет, содержит ли переданный параметр
