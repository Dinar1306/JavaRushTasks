...
combine - принимает на вход список любых коллекций и возвращает результирующий список, в котором находятся
все элементы из списков.

Добавь для каждого входящего типа List подходящий шаблон (wildcard), чтобы метод мог принимать только те элементы,
которые может обработать.
