...
public class Solution {
    ...
    public static final String BINDING_dog = "servers.dog";
    public static final String BINDING_cat = "servers.cat";
    ...
    public static Thread SERVER_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                registry.bind(BINDING_dog, remDog);
                registry.bind(BINDING_cat, remCat);
            } catch (RemoteException e) {
                e.printStackTrace();
