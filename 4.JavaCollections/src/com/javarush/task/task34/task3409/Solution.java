...
1. Создаём логгер  private static final Logger logger = LoggerFactory.getLogger(Solution.class);
2. После того как загрузили properties(после строчки properties.load(is))  конфигурируем наш логгер,   пишем:
