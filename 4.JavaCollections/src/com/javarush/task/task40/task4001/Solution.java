...
Примечание: метод main в тестировании не участвует, но чтобы программа корректно работала локально, можешь зайти на
сайт http://requestb.in/, создать свой RequestBin и использовать его в main.
...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        solution.sendPost(new URL("https://requestbin.jumio.com/121m8c31"), "name=zapp&mood=good&locale=&id=777");
    }
