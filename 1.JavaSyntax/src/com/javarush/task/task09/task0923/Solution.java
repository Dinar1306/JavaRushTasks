...
public class Solution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Character simvol = new Character(' ');
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        String stroka = br.readLine();
        for (int i = 0; i<stroka.length(); i++)
        {
            if(isVowel(stroka.charAt(i))) System.out.print(stroka.charAt(i)+ " ");
        }
        System.out.println();
        for (int i = 0; i<stroka.length(); i++)
        {
            simvol = stroka.charAt(i);
            //if(!isVowel(stroka.charAt(i))&&simvol.toString()!=" ") System.out.print(stroka.charAt(i)+ " ");
            if(!isVowel(stroka.charAt(i))&&stroka.charAt(i)!=' ') System.out.print(stroka.charAt(i)+ " ");
        }
    }
