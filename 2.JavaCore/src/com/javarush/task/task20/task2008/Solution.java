...
/*    public static Singleton serializeSingletonInstance(ByteArrayInputStream byteArrayInputStream) throws IOException, ClassNotFoundException {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();

        ObjectOutputStream oos = new ObjectOutputStream(byteArrayOutputStream);
        Singleton singleton = (Singleton) oos.writeObject(ourInstance);
        oos.close();
