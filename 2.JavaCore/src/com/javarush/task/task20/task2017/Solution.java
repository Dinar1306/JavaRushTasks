...
Десериализуй объект в методе getOriginalObject так, чтобы в случае возникновения исключения было выведено сообщение на экран
и возвращен null.
...
public class Solution {
    public A getOriginalObject(ObjectInputStream objectStream) throws Exception {
        ...
        try {
            /*if (objectStream.getClass().equals(A.class))
