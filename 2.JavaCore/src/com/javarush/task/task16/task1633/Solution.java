...
//        Вариант решения 2 (более правильный)
...
//        threadB.setUncaughtExceptionHandler(handler);
    ...
    public static class TestedThread extends Thread {
        public TestedThread(Thread.UncaughtExceptionHandler handler) {
            //UncaughtExceptionHandler(handler); // было так
            setDefaultUncaughtExceptionHandler(handler); // вариант решения 1 (установка обработчика (handler) на все потоки)
            start();
        }
