...
public class Solution {
    ...
    public static void printMatrix(double m, double n, Number value) {

    }

    public static void printMatrix(double m, short n, Number value) {

    }

    public static void printMatrix(byte m, short n, Number value) {

    }

    public static void printMatrix(char m, short n, Number value) {
