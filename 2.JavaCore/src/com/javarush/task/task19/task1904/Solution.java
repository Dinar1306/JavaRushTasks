...
6. Метод read() класса PersonScannerAdapter должен читать строку с файла, парсить её, и возвращать данные только одного человека,
    ...
    public static class PersonScannerAdapter implements PersonScanner{
        ...
        public Person read() throws IOException {
            ...
            if (fileScanner.hasNextLine()) {
                ...
                values = pattern.split(fileScanner.nextLine());
                String birthDateString = values[3]+" "+values[4]+" "+values[5];
            ...
            return new Person(values[1],values[2],values[0],birthDate);
        }
