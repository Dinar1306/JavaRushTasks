...
public class Solution {
    public static void main(String[] args) throws IOException {
        FileInputStream inputStream = new FileInputStream("D:/OneDrive/JR/strings.txt");
        // Создаем поток-записи-байт-в-файл
        FileOutputStream outputStream = new FileOutputStream("D:/OneDrive/JR/result.txt");
        byte[] buffer = new byte[inputStream.available()]; //переставил сюда
        ...
        //inputStream.reset(); нет такой команды (№1)
        //outputStream.flush(); //закрыл

        //добавил закрытие
        inputStream.close(); //закрываем оба потока. Они больше не нужны. (№2)
        outputStream.close();
    }
}
